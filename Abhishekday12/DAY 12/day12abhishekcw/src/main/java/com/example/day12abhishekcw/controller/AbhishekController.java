...
import com.example.day12abhishekcw.service.AbhishekService;
...
public class AbhishekController {
    ...
    @Autowired
    AbhishekService addressService;

    @SuppressWarnings("null")
    @PostMapping("/address/employee/{id}")
    public ResponseEntity<Abhishek> postMethodName(@RequestBody Abhishek address,@PathVariable int id) {
